...
| B | Complete (2026-07-15) | Canonical import and internal adapter registry | A | [Canonical import](2026-07-15-phase-b-canonical-import.md) |
| C | Complete (2026-07-15) | Strict protected Excel plan and four-function staff workflow | A, B | [Strict Excel workflow](2026-07-15-phase-c-strict-excel-workflow.md) |
| D | Complete (2026-07-15) | One report model rendered for three audiences | A, B, C | [Normalized reports](2026-07-15-phase-d-normalized-reports.md) |
| E | Next | Cross-platform acceptance and reproducible release | A-D | [Acceptance and release](2026-07-15-phase-e-acceptance-release.md) |
